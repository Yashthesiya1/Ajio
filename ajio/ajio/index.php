...
<html lang="en">
	<head>
		...
		<link href="assets/css/dark-red.css" rel="alternate stylesheet" title="Darkred color">
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">GET BRANDED DEALS</h4>
						</div>
					</div>	
					<h6 class="text">SHOP FROM AJIO </h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">FREE SHIPPING IN INDIA</h6>	
				</div>
			</div><!-- .col -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">MENS</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">WOMENS</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
